...
export const Summary = () => {
  return (
    <section className="summary-container w-[95dvw] min-h-[100dvh] py-6 flex flex-col items-center gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-2">
        ...
        <div className="summary-box bg-dark-blue p-6 rounded-xl shadow-md">
        ...
        <div className="summary-box bg-orange-gradient p-6 rounded-xl shadow-md">
